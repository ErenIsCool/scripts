...
local insults = {
    'nerd',--1
    'loser',--2
    'no bbititticehehes???',-- 3
    'you're so balon i had to make a whole new word to describe you',--4
    'you're so garbage the trash can runs away from you',--5
    'you're so bad kid get good',--6
    'you're so bad you failed the bonus round',--7
    'you're so stupid even cavemen said some \"confused oooga booga?\"',--8
    'did you learn to play from wikihow? explains alot!',--9
    'my guy you're so ugly when you use face scan on your phone it said humans only',--10
    'im way better than you',--11
    ...
    'bro you built like a \"Super Idol de xi\195\160or\195\179ng\". you're trash dog water kid. get good on your windows 1 pc',--15
    'you're so substandard you loser',--16
    'You're so poor you dirty clown',--17
    'you're inferior to me you peasant',--18
    'you're such a second-rate person',--19
    'you're a second-class person you garbage can', --20
    'you're whole life is unsatisfactory',--21
    'you're so stupid and inadequate',--22
    'your stupidity is unacceptable',--23
    'your brain is not up to scratch',--24
    'you're an not up to par loser',--25
    'you're deficient of intelligence',--26
    ...
    'you're an adverse piece of trash',--33
    ...
    'you're inspired by those cat posters that say \"the power comes from within\"',--45
    'you're useless you sorry worthless clown. go back to the circus if they even want you',--46
    'man you're built like a \"LeGo 75257 sTaR WaRs mIlLeNnIuM FaLcOn\"',--47
    ...
    'if the rock is strong then you're the soft',--54
    ...
    'you're dogwater kid get a life and go touch grass if you even know how wit yo decomposin brain',--59
